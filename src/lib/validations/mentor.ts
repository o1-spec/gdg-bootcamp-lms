...
export const resourceSchema = z.object({
  ...
  publicId: z.string().trim().optional().or(z.literal("")).nullable(),
  originalFileName: z.string().trim().optional().or(z.literal("")).nullable(),
  fileSize: z.coerce.number().int().optional().nullable(),
  mimeType: z.string().trim().optional().or(z.literal("")).nullable(),
  moduleId: z.string().min(1, "Module is required"),
