    ...
    <div className="flex min-h-screen bg-gdg-cream text-gdg-black antialiased selection:bg-gdg-yellow/30">
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <main className="flex-1 p-6 sm:p-8 lg:p-10 space-y-8 max-w-7xl w-full mx-auto">
          ...
          <div className="p-8 rounded-3xl bg-white border border-gdg-border shadow-sm relative overflow-hidden space-y-6">
            <div
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 pl-3">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2.5 py-1 rounded-full text-[10px] font-bold uppercase bg-gdg-blue/10 text-gdg-blue">
                    {assignment.type || 'PROJECT'}
                  </span>
                </div>
                <h1 className="text-3xl sm:text-4xl font-black text-gdg-black">
                  {assignment.title}
                </h1>
                <p className="text-sm text-gdg-gray max-w-3xl leading-relaxed font-medium">
                  {assignment.description}
                </p>
              </div>

              <div className="flex items-center gap-4 self-start md:self-auto flex-wrap">
                <div className="p-4 rounded-2xl bg-gdg-cream border border-gdg-border text-center min-w-[90px]">
                  <span className="text-[10px] font-bold uppercase text-gdg-gray block">Max Points</span>
                  <span className="text-2xl font-black text-gdg-black font-mono">{assignment.points}</span>
                </div>
                <div className="p-4 rounded-2xl bg-gdg-cream border border-gdg-border text-center min-w-[110px]">
                  <span className="text-[10px] font-bold uppercase text-gdg-gray block">Due Date</span>
                  <span className="text-xs font-black text-gdg-black">
            ...
            {assignment.instructions && (
              <div className="p-5 rounded-2xl bg-gdg-cream border border-gdg-border space-y-1.5 ml-3">
                <span className="text-xs font-black uppercase tracking-wider text-gdg-gray">
                  Instructions &amp; Grading Rubric
                </span>
                <p className="text-xs text-gdg-black whitespace-pre-wrap leading-relaxed font-mono">
                  {assignment.instructions}
                </p>
              </div>
            )}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
            <div className="p-4 rounded-2xl bg-white border border-gdg-border text-center">
              <span className="text-[10px] font-bold uppercase text-gdg-gray block">Enrolled</span>
              <span className="text-xl font-black text-gdg-black font-mono">{counts.totalStudents}</span>
            </div>
            <div className="p-4 rounded-2xl bg-white border border-gdg-border text-center">
              <span className="text-[10px] font-bold uppercase text-gdg-gray block">Submitted</span>
              <span className="text-xl font-black text-gdg-blue font-mono">{counts.submittedCount}</span>
            </div>
            <div className="p-4 rounded-2xl bg-white border border-gdg-border text-center">
              <span className="text-[10px] font-bold uppercase text-gdg-gray block">Pending Review</span>
              <span className="text-xl font-black text-gdg-red font-mono">{counts.pendingCount}</span>
            </div>
            <div className="p-4 rounded-2xl bg-white border border-gdg-border text-center">
              <span className="text-[10px] font-bold uppercase text-gdg-gray block">Reviewed</span>
              <span className="text-xl font-black text-gdg-green font-mono">{counts.reviewedCount}</span>
            </div>
            <div className="p-4 rounded-2xl bg-white border border-gdg-border text-center col-span-2 sm:col-span-1">
              <span className="text-[10px] font-bold uppercase text-gdg-gray block">Missing</span>
              <span className="text-xl font-black text-gdg-gray font-mono">{counts.missingCount}</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-xl font-black text-gdg-black">Student Submissions</h2>
            ...
            {filteredSubmissions.length === 0 ? (
              <div className="rounded-3xl bg-white border border-gdg-border p-12 text-center shadow-sm space-y-2">
                <div className="w-12 h-12 rounded-2xl bg-gdg-cream text-gdg-gray flex items-center justify-center mx-auto">
                  <Send className="h-6 w-6" />
                </div>
                <h3 className="text-base font-black text-gdg-black">No Submissions Found</h3>
                <p className="text-xs text-gdg-gray">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                {reviewingSubmission.student?.avatarUrl ? (
                  ...
                  <div className="w-12 h-12 rounded-2xl bg-gdg-black text-gdg-cream text-sm font-black flex items-center justify-center border border-gdg-border">
