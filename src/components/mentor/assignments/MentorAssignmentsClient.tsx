        ...
        <main className="flex-1 p-6 sm:p-8 lg:p-10 space-y-8 max-w-7xl w-full mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-6 rounded-3xl bg-white border border-gdg-border shadow-sm">
              <div className="flex items-center justify-between text-gdg-gray text-xs font-bold mb-2">
                <span>Total Assignments</span>
                <FileCheck className="h-4 w-4 text-gdg-blue" />
              </div>
              <p className="text-3xl font-black text-gdg-black font-mono">{assignments.length}</p>
              <span className="text-[11px] text-gdg-gray font-medium mt-1 block">
            ...
            <div className="p-6 rounded-3xl bg-white border border-gdg-border shadow-sm">
              ...
              <p className="text-3xl font-black text-gdg-red font-mono">{totalPending}</p>
              <span className="text-[11px] text-gdg-gray font-medium mt-1 block">
            ...
            <div className="p-6 rounded-3xl bg-white border border-gdg-border shadow-sm">
              ...
              <p className="text-3xl font-black text-gdg-green font-mono">{totalReviewed}</p>
              <span className="text-[11px] text-gdg-gray font-medium mt-1 block">
            ...
            <div className="p-6 rounded-3xl bg-white border border-gdg-border shadow-sm">
              ...
              <p className="text-3xl font-black text-gdg-black font-mono">{tracks.length}</p>
              <span className="text-[11px] text-gdg-gray font-medium mt-1 block">
          ...
          {filteredAssignments.length === 0 ? (
            <div className="rounded-3xl bg-white border border-gdg-border p-12 text-center shadow-sm max-w-md mx-auto space-y-4">
              <div className="w-14 h-14 rounded-2xl bg-gdg-red/10 text-gdg-red flex items-center justify-center mx-auto">
                <FileCheck className="h-7 w-7" />
              </div>
              <h3 className="text-lg font-black text-gdg-black">No Assignments Found</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredAssignments.map((asg) => {
                ...
                return (
                  <div
                    key={asg.id}
                    className="p-6 sm:p-8 rounded-3xl bg-white border border-gdg-border hover:border-gdg-black transition-all shadow-sm hover:shadow-md flex flex-col justify-between space-y-6 group"
                  >
                    <div className="space-y-4">
                      ...
                      <div>
                        <h3 className="text-xl font-black text-gdg-black group-hover:text-gdg-blue transition-colors">
                          {asg.title}
                        </h3>
                        <p className="text-xs text-gdg-gray mt-2 line-clamp-2 leading-relaxed">
                          {asg.description}
                        </p>
                      </div>
                      ...
                      <div className="p-4 rounded-2xl bg-gdg-cream border border-gdg-border space-y-2">
                        <div className="flex items-center justify-between text-xs">
                          <span className="font-bold text-gdg-gray">Student Submissions</span>
                          <span className="font-mono font-bold text-gdg-black">
                            {totalSubs} / {asg.totalStudents} ({asg.totalStudents > 0 ? Math.round((totalSubs / asg.totalStudents) * 100) : 0}%)
                          </span>
                        </div>

                        <div className="w-full h-2 bg-gdg-border rounded-full overflow-hidden flex">
                          <div
                            className="bg-gdg-green h-full"
                            style={{
                        ...
                        <div className="flex items-center justify-between text-[11px] text-gdg-gray pt-1">
                          <span className="text-gdg-green font-bold">
                            ✓ {asg.reviewedCount || 0} Reviewed
                          </span>
                          <span className="text-gdg-red font-bold">
                      ...
                      <div className="flex items-center justify-between text-xs text-gdg-gray">
                    ...
                    <div className="pt-4 border-t border-gdg-border flex items-center justify-between">
                      <Link
                        ...
                        className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gdg-black text-gdg-cream text-xs font-bold hover:bg-gdg-dark-border transition-colors"
                      >
