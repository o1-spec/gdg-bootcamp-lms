    ...
    <div className="flex min-h-screen bg-gdg-cream text-gdg-black antialiased selection:bg-gdg-yellow/30">
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8 max-w-7xl w-full mx-auto">
          {/* Header Banner */}
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-gdg-border pb-6 sm:pb-8">
          ...
          {/* Empty State */}
          {tracks.length === 0 ? (
            <div className="rounded-3xl border border-gdg-border bg-white p-12 text-center space-y-4 shadow-sm">
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gdg-yellow/20 text-gdg-yellow">
          ...
          <div className="rounded-3xl border border-gdg-dark-border bg-gdg-black text-gdg-cream p-6 sm:p-8 shadow-sm relative overflow-hidden">
            <div className="pointer-events-none absolute -bottom-10 -right-10 h-48 w-48 rounded-full bg-gdg-green/15 blur-3xl" />
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div className="space-y-2 max-w-2xl">
                ...
                <h3 className="text-xl sm:text-2xl font-black tracking-tight text-gdg-cream">
              ...
              {tracks[0] && (
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-gdg-cream text-gdg-black hover:bg-white px-6 py-3 text-xs font-black tracking-wide shrink-0 shadow-md transition-transform active:scale-95"
                >
