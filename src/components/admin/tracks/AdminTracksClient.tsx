          ...
          <div className="p-4 rounded-3xl bg-white/[0.02] border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              >
                ...
                {cohorts.map((c) => (
                  <option key={c.id} value={c.id} className="bg-[#0D0E11]">
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-white/5">
                      ...
                      {track.mentors.length === 0 ? (
                        ...
                        <div className="flex items-center -space-x-2">
                          {track.mentors.map((m) => (
                            <Avatar key={m.id} className="w-6 h-6 border border-[#0D0E11]">
                              <AvatarImage src={m.avatar || ''} alt={m.name} />
                              <AvatarFallback className="bg-[#FBBC04] text-black font-bold text-[9px]">
                                {m.name[0]}
                              </AvatarFallback>
                            </Avatar>
                          ))}
